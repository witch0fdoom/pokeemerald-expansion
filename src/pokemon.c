...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(RACCOONONE),
    HOENN_TO_NATIONAL(RACCOONTWO),
    HOENN_TO_NATIONAL(RACCOONTHREE),
    HOENN_TO_NATIONAL(POSSUMONE),
    HOENN_TO_NATIONAL(POSSUMTWO),
    HOENN_TO_NATIONAL(POSSUMTHREE),
    HOENN_TO_NATIONAL(SNAKEONE),
    HOENN_TO_NATIONAL(SNAKETWO),
    HOENN_TO_NATIONAL(SNAKETHREE),
    HOENN_TO_NATIONAL(SALYNX),
};
