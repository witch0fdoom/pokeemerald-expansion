...
enum {
    ...
    NATIONAL_DEX_POSSUMONE,
    NATIONAL_DEX_POSSUMTWO,
    NATIONAL_DEX_POSSUMTHREE,
    NATIONAL_DEX_RACCOONONE,
    NATIONAL_DEX_RACCOONTWO,
    NATIONAL_DEX_RACCOONTHREE,
    NATIONAL_DEX_SNAKEONE,
    NATIONAL_DEX_SNAKETWO,
    NATIONAL_DEX_SNAKETHREE,
    NATIONAL_DEX_SALYNX,
};
...
#if P_GEN_MIDWEST_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_SALYNX
...
enum {
    ...
    HOENN_DEX_POSSUMONE,
    HOENN_DEX_POSSUMTWO,
    HOENN_DEX_POSSUMTHREE,
    HOENN_DEX_RACCOONONE,
    HOENN_DEX_RACCOONTWO,
    HOENN_DEX_RACCOONTHREE,
    HOENN_DEX_SNAKEONE,
    HOENN_DEX_SNAKETWO,
    HOENN_DEX_SNAKETHREE,
    HOENN_DEX_SALYNX,

};

#define HOENN_DEX_COUNT (HOENN_DEX_SALYNX + 1)
